...
namespace BizArk.Core.Web
{
    ...
    public class WebHelperOptions
    {
        ...
        /// <summary>
        /// Gets or sets the default encoding for the response. This is only used if the response does not define an encoding.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a method that will be called after WebHelper has prepared the HttpWebRequest, but before the request is made.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a method that will be called when reporting progress.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a method that will be called when the request completes. Called if the request is successful, failed, or canceled. The parameters, in order, are the web helper making the request, the response, if any, the exception if failed, and a flag to indicate if the request was canceled.
        /// </summary>
